...
############## ADD CODE BELOW ####################
    ...
    while(sum_dp > tol):
        ...
        sum_dp = sum(dp)
        num_loops += 1
        print("Twiddle # " + " " + repr(num_loops) + " " + repr(params) + " -> " + repr(err))
...
params = twiddle()
print("twiddle done " + repr(params))
err = run(params, True)
print("\nFinal parameters: " + repr(params) + " " + repr(err))
# His took 107 steps to solve

#num_loops += 1
#print("Twiddle # " + repr(num_loops) + repr(myrobot) + " -> " + repr(cte))
