...
#            cte = ((ry * dx) - (rx * dy)) / normalizer 
        ...
        plotx.append(myrobot.x)
        ploty.append(myrobot.y)
        Z = myrobot.sense()
        filter.sense(Z)
...
tweaked_parameters = twiddle([weight_data, weight_smooth, p_gain, d_gain])

print main(grid, init, goal, steering_noise, distance_noise, measurement_noise, 
           tweaked_parameters[0],
           tweaked_parameters[1],
           tweaked_parameters[2],
           tweaked_parameters[3])
