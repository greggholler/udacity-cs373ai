...
def slam_working(data, N, num_landmarks, motion_noise, measurement_noise):
    #
    #
    # Add your code here!
    #
    ...
    for i in range(len(data)):
        ...
        print("Processing data point: " + repr(i))
        print("    dx: " + repr(dx))
        print("    dy: " + repr(dy))
        print("")
        print("    Landmarks")
        ...
        for j in range(len(Z)):
            ...
            print("        landmark number: " + repr(landmark_number))
            print("        landmark dist x: " + repr(landmark_distance_x))
            print("        landmark dist y: " + repr(landmark_distance_y))
            x = 2 * i
            y = x + 1
            x_index = x
            y_index = y
            ...
            # Update omega 
            omega.value[x_index][x_index]                   += val
            omega.value[x_index][landmark_x_index]          -= val
            omega.value[landmark_x_index][x_index]          -= val
            omega.value[landmark_x_index][landmark_x_index] += val
            omega.value[y_index][y_index]                   += val
            omega.value[y_index][landmark_y_index]          -= val
            omega.value[landmark_y_index][y_index]          -= val
            omega.value[landmark_y_index][landmark_y_index] += val
            ...
            # Update xi
            xi.value[x_index][0] -= landmark_distance_x
            xi.value[y_index][0] -= landmark_distance_y
            xi.value[landmark_x_index][0] += landmark_distance_x
            xi.value[landmark_y_index][0] += landmark_distance_y
...
def slam_orig(data, N, num_landmarks, motion_noise, measurement_noise):
    #
    #
    # Add your code here!
    #
    ...
    for i in range(len(data)):
        ...
        # Grab datapoint
        Z = data[i][0]
        #dx = (data[i][1][0] ** 2) / ((1 / motion_noise) ** 2)
        #dy = (data[i][1][1] ** 2) / ((1 / motion_noise) ** 2)
        dx = data[i][1][0]
        dy = data[i][1][1]
        #dx = data[i][1][0] * (1 / motion_noise)
        #dy = data[i][1][1] * (1 / motion_noise)
        ...
        motion_update = 1 / motion_noise
        #omega.value[x][x] += 1.
        #omega.value[x][x+2] -= 1.
        #omega.value[x+2][x] -= 1.
        #omega.value[x+2][x+2] += 1.
        #omega.value[y][y] += 1.
        #omega.value[y][y+2] -= 1.
        #omega.value[y+2][y] -= 1.
        #omega.value[y+2][y+2] += 1.
        omega.value[x][x]     += motion_update
        omega.value[x][x+2]   -= motion_update
        omega.value[x+2][x]   -= motion_update
        omega.value[x+2][x+2] += motion_update
        omega.value[y][y]     += motion_update
        omega.value[y][y+2]   -= motion_update
        omega.value[y+2][y]   -= motion_update
        omega.value[y+2][y+2] += motion_update
        ...
        for j in range(len(Z)):
            landmark_num = Z[j][0]
            #landmark_x   = (Z[j][1] ** 2) / ((1 / measurement_noise) ** 2)
            #landmark_y   = (Z[j][2] ** 2) / ((1 / measurement_noise) ** 2)
            landmark_x   = Z[j][1]
            landmark_y   = Z[j][2]
            #landmark_x   = Z[j][1] / (1 / measurement_noise)
            #landmark_y   = Z[j][2] / (1 / measurement_noise)

            print("        num: " + repr(landmark_num))
            print("          x: " + repr(landmark_x))
            print("          y: " + repr(landmark_y))
            x_index = x + 2
            y_index = y + 2
            landmark_x_index = landmark_index + (2 * landmark_num)
            landmark_y_index = landmark_index + (2 * landmark_num) + 1

            measurement_update = 1 / measurement_noise
            # Update omega 
            #omega.value[x_index][x_index] += 1
            #omega.value[x_index][landmark_x_index] -= 1
            #omega.value[landmark_x_index][x_index] -= 1
            #omega.value[landmark_x_index][landmark_x_index] += 1
            #omega.value[y_index][y_index] += 1
            #omega.value[y_index][landmark_y_index] -= 1
            #omega.value[landmark_y_index][y_index] -= 1
            #omega.value[landmark_y_index][landmark_y_index] += 1
            omega.value[x_index][x_index] += measurement_update
            omega.value[x_index][landmark_x_index] -= measurement_update
            omega.value[landmark_x_index][x_index] -= measurement_update
            omega.value[landmark_x_index][landmark_x_index] += measurement_update
            omega.value[y_index][y_index] += measurement_update
            omega.value[y_index][landmark_y_index] -= measurement_update
            omega.value[landmark_y_index][y_index] -= measurement_update
            omega.value[landmark_y_index][landmark_y_index] += measurement_update

            # Update xi
            xi.value[x_index][0] -= landmark_x
            xi.value[y_index][0] -= landmark_y
            xi.value[landmark_x_index][0] += landmark_x
            xi.value[landmark_y_index][0] += landmark_y
